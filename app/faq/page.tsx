  ...
  const faqCategories = [
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer: 'ahamo、povo、LINEMOなどのオンライン専用プランは、親会社と同等の通信品質を提供しています。その他のMVNOは同じ回線を使用していますが、混雑時に速度制限がかかる場合があります。ただし、日常的な利用には十分な品質を確保しています。'
        }
      ]
    },
    {
    ...
    },
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer: '2025年10月以降に発売された端末はSIMフリーが義務化されているため不要です。それ以前の端末で他社回線の格安SIMを使用する場合は、SIMロック解除が必要になる場合があります。各キャリアのWebサイトや店舗で手続き可能です。'
        }
      ]
    }
  ];
